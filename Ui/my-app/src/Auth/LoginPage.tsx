      ...
      <div className="w-full max-w-[380px] space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-black px-4 text-zinc-600 font-medium">Or continue with email</span>
          </div>
        </div>
        ...
        <p className="text-center text-zinc-500 text-sm">
          ...
          <Link to="/register" className="text-zinc-300 hover:text-white font-medium underline-offset-4 hover:underline">
            Create an account
          </Link>
        </p>
      </div>
